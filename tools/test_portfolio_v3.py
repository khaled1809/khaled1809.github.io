...
class PortfolioV3Tests(unittest.TestCase):
    ...
    def test_portfolio_contains_seventeen_projects_and_updated_metrics(self) -> None:
        ...
        self.assertEqual(list(NEW_SLUGS), [project["slug"] for project in self.data["projects"][5:8]])
